...
%Calculate initial conditions for the conductance related variables
...
%     plot(t,V_rest);               %The voltage plot
plot(t,gK,'r-')                     %the Potassium conductance
hold on
plot(t,gNa,'b-')                    %the Sodium conductance
